            ...
            <div className='sectionServicios'>
                    <Card className='cardTransition'>
                        ...
                        <Card.ImgOverlay>
                            ...
                            <Card.Body style={{ blackFilter: 'blur(0)', height: '11rem', marginTop: '10rem', backdropFilter: 'blur(3px)', backgroundColor: 'rgba(255,255, 255,.5)', boxShadow: '#00000070 0px 0px 10px', borderRadius: '2%',}}>
                    ...
                    <Card className='cardTransition'>
                        ...
                        <Card.ImgOverlay>
                            ...
                            <Card.Body style={{ height: '11rem', display: 'flex', bottom: '0', marginTop: '10rem', backdropFilter: 'blur(3px)', backgroundColor: 'rgba(255,255, 255,.5)', boxShadow: '#00000070 0px 0px 10px', borderRadius: '2%'}}>
                    ...
                    <Card className='cardTransition'>
                        ...
                        <Card.ImgOverlay>
                            ...
                            <Card.Body style={{ height: '11rem', display: 'flex', bottom: '0', marginTop: '10rem', backdropFilter: 'blur(3px)', backgroundColor: 'rgba(255,255, 255,.5)', boxShadow: '#00000090 0px 0px 10px', borderRadius: '2%'}}>
                                Hacemos que tu sitio web sea atractivo, ordenado y funcional. El/la usuarix estará a gusto al navegar por él, en una interfaz gráfica correcta, atractiva y limpia.
                            </Card.Body>
                        </Card.ImgOverlay>
                    </Card>
